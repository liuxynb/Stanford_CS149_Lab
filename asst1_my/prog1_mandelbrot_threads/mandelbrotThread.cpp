...
void workerThreadStart(WorkerArgs *const args)
{
    ...
    // The code below is the first implementation.
    /*
    double startTime = CycleTimer::currentSeconds();                   // start time
    int startRow = args->threadId * (args->height / args->numThreads); // 计算每个线程的起始行
    int numRows = args->height / args->numThreads;                     // 计算每个线程的行数
    ...
    */
    ...
    // The code below is the second implementation.
    // double startTime = CycleTimer::currentSeconds(); // start time
